...
public class AbstractReadCharacteristicActionTest {
    ...
    @Test
    public void executeWhenReadCharacteristicReturnsFalse() throws Exception {
        when(mGattWrapper.readCharacteristic(any(BluetoothGattCharacteristic.class))).thenReturn(false);
    ...
    @Test
    public void executeWhenReadCharacteristicReturnsTrue() throws Exception {
        when(mGattWrapper.readCharacteristic(any(BluetoothGattCharacteristic.class))).thenReturn(true);
